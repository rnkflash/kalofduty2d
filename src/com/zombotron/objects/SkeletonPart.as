package com.zombotron.objects
{
    ...
    public class SkeletonPart extends BasicObject implements IItemObject
    {
        ...
        public static const CACHE_NAME:String = "SkeletonParts";
        public static const LEG_RIGHT:int = 3;
        public static const HAND_RIGHT:int = 6;
        public static const HELMET:int = 7;
        public static const SHEILD:int = 8;
        public static const LEG_LEFT:int = 4;
        public static const SWORD:int = 9;
        public static const HAND_LEFT:int = 5;

        public function SkeletonPart()
        {
            this._tm = new TaskManager();
            _kind = Kind.SKELETON_PART;
            _sprite = ZG.animCache.getAnimation(Art.SKELETON_PARTS);
            return;
        }// end function
        ...
        override public function init(param1:Number, param2:Number, param3:Number = 0, param4:Number = 1) : void
        {
            ...
            this._lifeTime = 250;
            this._tm.clear();
            if (ZG.playerGui.isHaveMission(LevelBase.MISSION_SKELETON) && variety == HEAD)
            {
        ...
        public function collect() : void
        {
            ...
            if (!this._isCollected && ZG.playerGui.isHaveMission(LevelBase.MISSION_SKELETON))
            {
                _loc_1 = EffectCollectableItem.get();
                _loc_1.variety = ShopBox.ITEM_HEAD_SKELETON;
        ...
        public static function get() : SkeletonPart
        {
            return ZG.universe.cacheStorage.getInstance(CACHE_NAME) as SkeletonPart;
        }// end function
