package com.zombotron.objects
{
    ...
    public class EnemyZombie extends BasicEnemy implements IEnemyObject
    {
        ...
        public static const CACHE_NAME:String = "EnemyZombies";
        ...
        private static const DAMAGE:Number = 0.3;
        ...
        private function onStayAnim() : Boolean
        {
            ...
            switch(this._color)
            {
                case COLOR_GREEN:
                {
                    _loc_1 = Art.ZOMBIE_STAND_GREEN;
                    break;
                }
                case COLOR_ORANGE:
                {
                    _loc_1 = Art.ZOMBIE_STAND_ORANGE;
                    break;
                }
                default:
                {
                    _loc_1 = Art.ZOMBIE_STAND_BLUE;
                    break;
                    break;
                }
            }
        ...
        override public function init(param1:Number, param2:Number, param3:Number = 0, param4:Number = 1) : void
        {
            ...
            switch(this._color)
            {
                case COLOR_GREEN:
                {
                    _loc_5 = Art.ZOMBIE_STAND_GREEN;
                    break;
                }
                case COLOR_ORANGE:
                {
                    _loc_5 = Art.ZOMBIE_STAND_ORANGE;
                    break;
                }
                default:
                {
                    _loc_5 = Art.ZOMBIE_STAND_BLUE;
                    break;
                    break;
                }
            }
        ...
        private function onWalkAnim() : Boolean
        {
            ...
            switch(this._color)
            {
                case COLOR_GREEN:
                {
                    _loc_1 = Art.ZOMBIE_WALK_GREEN;
                    break;
                }
                case COLOR_ORANGE:
                {
                    _loc_1 = Art.ZOMBIE_WALK_ORANGE;
                    break;
                }
                default:
                {
                    _loc_1 = Art.ZOMBIE_WALK_BLUE;
                    break;
                    break;
                }
            }
        ...
        private function makeDeadBody(param1:Number, param2:Number) : void
        {
            ...
            if (_loc_16 != ShopBox.ITEM_UNDEFINED)
            {
                ...
                _loc_17 = _universe.makeCollectableItem(_loc_16, 1, param1, param2);
                _loc_17.body.ApplyImpulse(_loc_14, _loc_17.body.GetWorldCenter());
            }
            return;
        }// end function
        ...
        private function onAttackAnim() : Boolean
        {
            ...
            switch(this._color)
            {
                case COLOR_GREEN:
                {
                    _loc_1 = Art.ZOMBIE_ATTACK_GREEN;
                    break;
                }
                case COLOR_ORANGE:
                {
                    _loc_1 = Art.ZOMBIE_ATTACK_ORANGE;
                    break;
                }
                default:
                {
                    _loc_1 = Art.ZOMBIE_ATTACK_BLUE;
                    break;
                    break;
                }
            }
        ...
        public static function get() : EnemyZombie
        {
            return ZG.universe.cacheStorage.getInstance(CACHE_NAME) as EnemyZombie;
        }// end function
