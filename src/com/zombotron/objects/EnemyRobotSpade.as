package com.zombotron.objects
{
    ...
    public class EnemyRobotSpade extends BasicEnemy implements IEnemyObject
    {
        ...
        public static const CACHE_NAME:String = "EnemyRobotSpades";
        ...
        private static const HEALTH:Number = 1.4;
        ...
        private static const DAMAGE:Number = 0.4;
        ...
        {
            switchAnim(Art.ROBOT_STAND_SPADE);
            return true;
        }// end function
        ...
        {
            switchAnim(Art.ROBOT_WALK_SPADE);
            return true;
        }// end function
        ...
        {
            switchAnim(Art.ROBOT_ATTACK_SPADE, false);
            return true;
        }// end function
        ...
        public static function get() : EnemyRobotSpade
        {
            return ZG.universe.cacheStorage.getInstance(CACHE_NAME) as EnemyRobotSpade;
        }// end function
